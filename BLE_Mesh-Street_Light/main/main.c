...
#define ESP_BLE_MESH_MODEL_OP_BATTERY_STATUS    ESP_BLE_MESH_MODEL_OP_3(0x02, CID_ESP)
...
ESP_BLE_MESH_MODEL_PUB_DEFINE(battery_pub, 2 + 4, ROLE_NODE); // 2 opcode + 4 voltage data
static esp_ble_mesh_model_op_t battery_op[] = {
    // {
    //     ESP_BLE_MESH_MODEL_OP_BATTERY_STATUS, 0 
    // }, // No payload expected in GET (or define your own GET)
    ESP_BLE_MESH_MODEL_OP(ESP_BLE_MESH_MODEL_OP_BATTERY_STATUS, 2),
    ESP_BLE_MESH_MODEL_OP_END,
};

ESP_BLE_MESH_MODEL_PUB_DEFINE(vnd_pub, 2 + 4, ROLE_NODE); // 2 opcode + 4 voltage data
static esp_ble_mesh_model_op_t vnd_op[] = {
    ESP_BLE_MESH_MODEL_OP(ESP_BLE_MESH_VND_MODEL_OP_SEND, 2),
    ESP_BLE_MESH_MODEL_OP_END,
};

static esp_ble_mesh_model_t battery_model[] = {
    ESP_BLE_MESH_VENDOR_MODEL(CID_ESP, 0x0001, battery_op, &battery_pub, NULL),
    // ESP_BLE_MESH_VENDOR_MODEL(CID_ESP, 0x0001, vnd_op, NULL, NULL),
};
...
static esp_ble_mesh_elem_t elements[] = {
    ESP_BLE_MESH_ELEMENT(0, root_models, battery_model),
    // ESP_BLE_MESH_ELEMENT(0, battery_model, vnd_models),
};
                                             ...
                                             esp_ble_mesh_model_cb_param_t *param)
{
    ...
    case ESP_BLE_MESH_MODEL_OPERATION_EVT:
        if (param->model_operation.opcode == ESP_BLE_MESH_VND_MODEL_OP_SEND) {
            ...
            err = esp_ble_mesh_server_model_send_msg(&battery_model[0],
                    param->model_operation.ctx, ESP_BLE_MESH_MODEL_OP_BATTERY_STATUS,
                    sizeof(tid), (uint8_t *)&tid);
            if (err) {
                ESP_LOGE(TAG, "Failed to send message 0x%06x", ESP_BLE_MESH_VND_MODEL_OP_STATUS);
                // ESP_LOGE(TAG, "Failed to send message 0x%06x", ESP_BLE_MESH_MODEL_OP_BATTERY_STATUS);
            }
        }
        break;
